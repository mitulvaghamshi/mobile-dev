package com.example.wordlookup.adapter
...
import com.example.wordlookup.R
import com.example.wordlookup.DetailActivity

/**
 * Adapter for the [RecyclerView] in [MasterActivity].
 */
        ...
        with(holder.button) {
            ...
            setOnClickListener {
                ...
                val intent = Intent(context, DetailActivity::class.java)
                    .putExtra(DetailActivity.LETTER, text.toString())
