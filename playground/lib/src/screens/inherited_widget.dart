...
class InharitedWidgetApp extends StatelessWidget {
  const InharitedWidgetApp({Key? key}) : super(key: key);

  static const routeName = '/inharitedwidget';

  @override
  Widget build(BuildContext context) {
    return const AppStateWidget(child: MyStorePage());
  }
}
