...
class SphereState extends State<Sphere> with TickerProviderStateMixin {
  Uint32List? surface;
  ...
  void initState() {
    ...
    rotationZController = AnimationController(vsync: this)
      ..addListener(() => setState(() => rotationZ = rotationZAnimation.value));
    loadSurface();
  }
      ...
      child: LayoutBuilder(
        builder: (_, constraints) {
          return FutureBuilder(
            ...
            builder: (_, AsyncSnapshot<SphereImage> snapshot) {
              return CustomPaint(
...
class SpherePainter extends CustomPainter {
  const SpherePainter(this.sphereImage);
